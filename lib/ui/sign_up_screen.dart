...
import '../CryptoModel/UserModel.dart';
        ...
        builder: (context, constraints){
          if (constraints.maxWidth > 600) {
                ...
                Flexible(
                  child: Column(
                    ...
                    children: [
                      RotatedBox(
                          quarterTurns: 3,
                          child: Lottie.asset('assets/bitcointouch.json',fit: BoxFit.fill)),
                    ],
                  ),
                ),
                Flexible(
                                    ...
                                    builder: (context, userDataProvider, child){
                                      switch(userDataProvider.registerStatus?.status){
                                        ...
                                        case Status.COMPLETED:
                                          ...
                                          WidgetsBinding.instance.addPostFrameCallback((timeStamp) => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) =>  MainWrapper())));
                                          return signupBtn();
                                        case Status.ERROR:
                                          return Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
            ...
            return Column(
              ...
              children: [
                // const SizedBox(height: 30,),
                Lottie.asset('assets/waveloop.json',height: height * 0.2,width: double.infinity,fit: BoxFit.fill),
                const SizedBox(height: 10,),
                Padding(
                  padding: const EdgeInsets.only(left: 20.0),
                  child: Text('Sign Up',style: GoogleFonts.ubuntu(fontSize: height * 0.035,color: Theme.of(context).unselectedWidgetColor,fontWeight: FontWeight.bold)),
